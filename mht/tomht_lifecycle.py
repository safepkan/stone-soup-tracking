...
def track_miss_termination_leaves(
    *,
    ...
    """Return leaves to evaluate for whole-track miss/deleter termination."""
...
def apply_post_n_scan_track_miss_lifecycle(
    *,
    tree_store: TrackTreeStore,
    map_global: GlobalHypothesis,
    cluster_snapshots: list[ClusterRebuildSnapshot],
    ...
    """Apply whole-track score/miss termination after N-scan pruning."""
...
def apply_post_n_scan_track_deleter_lifecycle(
    *,
    tree_store: TrackTreeStore,
    map_global: GlobalHypothesis,
    cluster_snapshots: list[ClusterRebuildSnapshot],
    ...
    """Apply whole-track score/deleter termination after N-scan pruning."""
    mode = normalized_track_miss_termination_mode(params.track_miss_termination_mode)
...
def apply_post_n_scan_track_lifecycle(
    *,
    ...
    if deleter is not None:
        return apply_post_n_scan_track_deleter_lifecycle(
            tree_store=tree_store,
            map_global=map_global,
            cluster_snapshots=cluster_snapshots,
            params=params,
            deletion_log_odds_threshold=deletion_log_odds_threshold,
            deleter=deleter,
            output_track_id_for_deleter=output_track_id_for_deleter,
            timestamp=timestamp,
        )
    return apply_post_n_scan_track_miss_lifecycle(
        tree_store=tree_store,
        map_global=map_global,
        cluster_snapshots=cluster_snapshots,
        params=params,
