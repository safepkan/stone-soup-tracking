...
> This file tracks later corrections (e.g. the since-removed `.predictor` wiring
> requirement) and may drift from the version posted in the thread; the posted
> original is this file's first revision in git history.
